...
#copy briefing file to BMS432 directory

echo " "

if [ -f "$WINEPREFIX/drive_c/Falcon BMS 4.32/User/Briefings/Briefing.txt" ]
then 
	echo "Copying mission briefing file Briefing.txt to BMS432 directory"
	cp "$WINEPREFIX/drive_c/Falcon BMS 4.32/User/Briefings/Briefing.txt" $WINEPREFIX/..
else
...
if [ -f "$WINEPREFIX/drive_c/Falcon BMS 4.32/User/Briefings/debrief.txt" ]
then 
	echo "Copying mission debrief file debrief.txt to BMS432 directory"
	cp "$WINEPREFIX/drive_c/Falcon BMS 4.32/User/Briefings/debrief.txt" $WINEPREFIX/..
else

...
if [ ! -f Tacview176Setup.exe ]; then
        echo " "
        echo "ERROR: Tacview176Setup.exe not found in BMS433 directory.  Copy this file from the $HOME/esports-for-engineers-v31/SAT/INSTALL directory."
        exit 1
fi

if [ ! -d  Weapon_Delivery_Planner_3.7.8.101 ]; then
        echo " "
        echo "ERROR: Weapon_Delivery_Planner_3.7.8.101 directory not found in BMS432 directory."
        echo "Download and unpack Weapon Delivery Planner from"
	echo "https://web.archive.org/web/20200612224848/http://www.weapondeliveryplanner.nl/files/wdp/Weapon_Delivery_Planner_3.7.8.101.7z"
        exit 1
fi
...
cd Weapon_Delivery_Planner_3.7.8.101

if [ ! -f setup.exe ]; then
        echo " "
        echo "ERROR: Weapon_Delivery_Planner_3.7.8.101/setup.exe not found."
        exit 1
fi

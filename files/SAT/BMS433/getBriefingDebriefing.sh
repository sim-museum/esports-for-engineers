...
#copy briefing file to BMS433 directory

echo " "

if [ -f "$WINEPREFIX/drive_c/Falcon BMS 4.33 U1/User/Briefings/Briefing.txt" ]
then 
	echo "Copying mission briefing file Briefing.txt to BMS433 directory"
	cp "$WINEPREFIX/drive_c/Falcon BMS 4.33 U1/User/Briefings/Briefing.txt" $WINEPREFIX/..
else
...
if [ -f "$WINEPREFIX/drive_c/Falcon BMS 4.33 U1/User/Briefings/debrief.txt" ]
then 
	echo "Copying mission debrief file debrief.txt to BMS433 directory"
	cp "$WINEPREFIX/drive_c/Falcon BMS 4.33 U1/User/Briefings/debrief.txt" $WINEPREFIX/..
else

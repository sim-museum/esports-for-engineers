...
fgfs --start-date-sys=2020:06:01:12:00:00 --aircraft=p51d-jsbsim --fg-aircraft=$HOME/.fgfs/Aircraft/org.flightgear.fgaddon.trunk/Aircraft --in-air --altitude=10000 --vc=200 --enable-freeze 2>/dev/null 1>/dev/null

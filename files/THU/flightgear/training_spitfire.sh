...
# learn cockpit instruments, practice takeoff and landing in a Spitfire IIa

if [ ! -f /usr/games/fgfs ]; then
	echo " "
	echo "The flightgear open source flight simulator is not installed."
	echo "Run THU/flightgear/optionalFlightgearInstall.sh for installation steps,"
